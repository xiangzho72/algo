...
// Actually when vector A has a number of elements selected,  vector B can only have one value to 
// meet the requirement.  So this is to build up from the base cases
//
//
/*
